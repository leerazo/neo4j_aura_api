...
def parseargs(defaults=None, config_files=None):
    ...
    parser.add_argument('--delete-instance', metavar="INSTANCE_ID", help="List Aura tenants")
    ...
    parser.add_argument('---id', metavar="INSTANCE_ID", help="List Aura tenants")
    parser.add_argument('--tenant-id', metavar="TENANT_ID", help="List Aura tenants")
